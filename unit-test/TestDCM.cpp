...
TEST(DCMTestSuite, TestInitializerListConstructor)
{
    matrix::DCM<int> d = {{1, 2, 3}, {4, 5, 6}, {7, 8, 9}};
    EXPECT_EQ(1, d(0,0));
    EXPECT_EQ(2, d(0,1));
    EXPECT_EQ(3, d(0,2));
    EXPECT_EQ(4, d(1,0));
...
TEST(DCMTestSuite, TestEulerAngleConversionConstructor)
{
    ...
    EXPECT_DOUBLE_EQ(0.22813884797452991, d1(0,0));
    EXPECT_DOUBLE_EQ(0.90135763924193235, d1(0,1));
    EXPECT_DOUBLE_EQ(0.36811285256706888, d1(0,2));
    EXPECT_DOUBLE_EQ(-0.69278646414614875, d1(1,0));
    EXPECT_DOUBLE_EQ(0.41593717755472648, d1(1,1));
    EXPECT_DOUBLE_EQ(-0.58910370854687788, d1(1,2));
    EXPECT_DOUBLE_EQ(-0.68410494892284712, d1(2,0));
    EXPECT_DOUBLE_EQ(-0.12062616013128424, d1(2,1));
    EXPECT_DOUBLE_EQ(0.71933980033865119, d1(2,2));

    matrix::Euler<double> e2(angle1, angle2, angle3, RotationSequence::XYX_121);
    matrix::DCM<double> d2(e2);
    EXPECT_DOUBLE_EQ(0.71933980033865119, d2(0,0));
    EXPECT_DOUBLE_EQ(-0.68410494892284712, d2(0,1));
    EXPECT_DOUBLE_EQ(-0.12062616013128424, d2(0,2));
    EXPECT_DOUBLE_EQ(0.36811285256706888, d2(1,0));
    EXPECT_DOUBLE_EQ(0.22813884797452991, d2(1,1));
    EXPECT_DOUBLE_EQ(0.90135763924193235, d2(1,2));
    EXPECT_DOUBLE_EQ(-0.58910370854687788, d2(2,0));
    EXPECT_DOUBLE_EQ(-0.69278646414614875, d2(2,1));
    EXPECT_DOUBLE_EQ(0.41593717755472648, d2(2,2));

    matrix::Euler<double> e3(angle1, angle2, angle3, RotationSequence::YZY_232);
    matrix::DCM<double> d3(e3);
    EXPECT_DOUBLE_EQ(0.41593717755472648, d3(0,0));
    EXPECT_DOUBLE_EQ(-0.58910370854687788, d3(0,1));
    EXPECT_DOUBLE_EQ(-0.69278646414614875, d3(0,2));
    EXPECT_DOUBLE_EQ(-0.12062616013128424, d3(1,0));
    EXPECT_DOUBLE_EQ(0.71933980033865119, d3(1,1));
    EXPECT_DOUBLE_EQ(-0.68410494892284712, d3(1,2));
    EXPECT_DOUBLE_EQ(0.90135763924193235, d3(2,0));
    EXPECT_DOUBLE_EQ(0.36811285256706888, d3(2,1));
    EXPECT_DOUBLE_EQ(0.22813884797452991, d3(2,2));
    ...
    EXPECT_DOUBLE_EQ(0.71933980033865119, d5(0,0));
    EXPECT_DOUBLE_EQ(0.12062616013128424, d5(0,1));
    EXPECT_DOUBLE_EQ(-0.68410494892284712, d5(0,2));
    EXPECT_DOUBLE_EQ(0.58910370854687788, d5(1,0));
    EXPECT_DOUBLE_EQ(0.41593717755472648, d5(1,1));
    EXPECT_DOUBLE_EQ(0.69278646414614875, d5(1,2));
    EXPECT_DOUBLE_EQ(0.36811285256706888, d5(2,0));
    EXPECT_DOUBLE_EQ(-0.90135763924193235, d5(2,1));
    EXPECT_DOUBLE_EQ(0.22813884797452991, d5(2,2));

    matrix::Euler<double> e6(angle1, angle2, angle3, RotationSequence::YXY_212);
    matrix::DCM<double> d6(e6);
    EXPECT_DOUBLE_EQ(0.22813884797452991, d6(0,0));
    EXPECT_DOUBLE_EQ(0.36811285256706888, d6(0,1));
    EXPECT_DOUBLE_EQ(-0.90135763924193235, d6(0,2));
    EXPECT_DOUBLE_EQ(-0.68410494892284712, d6(1,0));
    EXPECT_DOUBLE_EQ(0.71933980033865119, d6(1,1));
    EXPECT_DOUBLE_EQ(0.12062616013128424, d6(1,2));
    EXPECT_DOUBLE_EQ(0.69278646414614875, d6(2,0));
    EXPECT_DOUBLE_EQ(0.58910370854687788, d6(2,1));
    EXPECT_DOUBLE_EQ(0.41593717755472648, d6(2,2));

    matrix::Euler<double> e7(angle1, angle2, angle3, RotationSequence::XYZ_123);
    matrix::DCM<double> d7(e7);
    EXPECT_DOUBLE_EQ(-0.12491204545210027, d7(0,0));
    EXPECT_DOUBLE_EQ(0.70841141242375738, d7(0,1));
    EXPECT_DOUBLE_EQ(0.69465837045899725, d7(0,2));
    EXPECT_DOUBLE_EQ(-0.89908646604613762, d7(1,0));
    EXPECT_DOUBLE_EQ(0.21525838472001627, d7(1,1));
    EXPECT_DOUBLE_EQ(-0.38119201772911854, d7(1,2));
    EXPECT_DOUBLE_EQ(-0.4195718144413893, d7(2,0));
    EXPECT_DOUBLE_EQ(-0.67217341404990605, d7(2,1));
    EXPECT_DOUBLE_EQ(0.61003474816673675, d7(2,2));

    matrix::Euler<double> e8(angle1, angle2, angle3, RotationSequence::YZX_231);
    matrix::DCM<double> d8(e8);
    EXPECT_DOUBLE_EQ(0.61003474816673675, d8(0,0));
    EXPECT_DOUBLE_EQ(-0.4195718144413893, d8(0,1));
    EXPECT_DOUBLE_EQ(-0.67217341404990605, d8(0,2));
    EXPECT_DOUBLE_EQ(0.69465837045899725, d8(1,0));
    EXPECT_DOUBLE_EQ(-0.12491204545210027, d8(1,1));
    EXPECT_DOUBLE_EQ(0.70841141242375738, d8(1,2));
    EXPECT_DOUBLE_EQ(-0.38119201772911854, d8(2,0));
    EXPECT_DOUBLE_EQ(-0.89908646604613762, d8(2,1));
    EXPECT_DOUBLE_EQ(0.21525838472001627, d8(2,2));

    matrix::Euler<double> e9(angle1, angle2, angle3, RotationSequence::ZXY_312);
    matrix::DCM<double> d9(e9);
    EXPECT_DOUBLE_EQ(0.21525838472001638, d9(0,0));
    EXPECT_DOUBLE_EQ(-0.3811920177291186, d9(0,1));
    EXPECT_DOUBLE_EQ(-0.8990864660461377, d9(0,2));
    EXPECT_DOUBLE_EQ(-0.672173414049906, d9(1,0));
    EXPECT_DOUBLE_EQ(0.6100347481667368, d9(1,1));
    EXPECT_DOUBLE_EQ(-0.41957181444138936, d9(1,2));
    EXPECT_DOUBLE_EQ(0.7084114124237575, d9(2,0));
    EXPECT_DOUBLE_EQ(0.6946583704589973, d9(2,1));
    EXPECT_DOUBLE_EQ(-0.12491204545210033, d9(2,2));

    matrix::Euler<double> e10(angle1, angle2, angle3, RotationSequence::XZY_132);
    matrix::DCM<double> d10(e10);
    EXPECT_DOUBLE_EQ(-0.12491204545210027, d10(0,0));
    EXPECT_DOUBLE_EQ(-0.6946583704589973, d10(0,1));
    EXPECT_DOUBLE_EQ(-0.7084114124237575, d10(0,2));
    EXPECT_DOUBLE_EQ(-0.6241653853333808, d10(1,0));
    EXPECT_DOUBLE_EQ(0.6100347481667368, d10(1,1));
    EXPECT_DOUBLE_EQ(-0.4881343849605131, d10(1,2));
    EXPECT_DOUBLE_EQ(0.7712422139980439, d10(2,0));
    EXPECT_DOUBLE_EQ(0.3811920177291186, d10(2,1));
    EXPECT_DOUBLE_EQ(-0.5097823976629624, d10(2,2));
    ...
    EXPECT_DOUBLE_EQ(-0.5097823976629624, d12(0,0));
    EXPECT_DOUBLE_EQ(0.7712422139980439, d12(0,1));
    EXPECT_DOUBLE_EQ(0.3811920177291186, d12(0,2));
    EXPECT_DOUBLE_EQ(-0.7084114124237575, d12(1,0));
    EXPECT_DOUBLE_EQ(-0.12491204545210027, d12(1,1));
    EXPECT_DOUBLE_EQ(-0.6946583704589973, d12(1,2));
    EXPECT_DOUBLE_EQ(-0.4881343849605131, d12(2,0));
    EXPECT_DOUBLE_EQ(-0.6241653853333808, d12(2,1));
    EXPECT_DOUBLE_EQ(0.6100347481667368, d12(2,2));
}

TEST(DCMTestSuite, TestTextbookExample)
{
    matrix::DCM<double> Q = {{-0.8729, 0.4364, 0.2182}, {-0.3318, -0.8588, 0.3904}, {0.3578, 0.2683, 0.8944}};
    matrix::Vector3<double> v = {2.0, 4.0, 6.0};
    matrix::Vector3<double> v_prime = Q * v;
