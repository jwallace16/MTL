...
TEST(DCMTestSuite, TestQuaternionConversionConstructor)
{
    ...
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d8(0,0));
    EXPECT_DOUBLE_EQ(1.0, d8(0,1));
    EXPECT_DOUBLE_EQ(0.0, d8(0,2));
    EXPECT_DOUBLE_EQ(1.0, d8(1,0));
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d8(1,1));
    ...
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d9(0,0));
    ...
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d9(2,2));
    ...
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d10(1,1));
    EXPECT_DOUBLE_EQ(1.0, d10(1,2));
    EXPECT_DOUBLE_EQ(0.0, d10(2,0));
    EXPECT_DOUBLE_EQ(1.0, d10(2,1));
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d10(2,2));
    ...
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d11(1,1));
    EXPECT_DOUBLE_EQ(1.0, d11(1,2));
    EXPECT_DOUBLE_EQ(0.0, d11(2,0));
    EXPECT_DOUBLE_EQ(-1.0, d11(2,1));
    EXPECT_DOUBLE_EQ(-2.220446049250313e-16, d11(2,2));
}